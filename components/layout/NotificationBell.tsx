...
const mockNotifications: Notification[] = [
  {
    ...
    type: NotificationType.NOTE_VALIDATED,
      ...
      message: 'Votre document "Convention annuelle 2025" a été validé par Jean Dupont',
    relatedNoteId: '1',
    isRead: false,
  ...
  },
  {
    ...
    type: NotificationType.COMMENT_ADDED,
      ...
      message: 'Marie Martin a ajouté un commentaire sur votre document',
    relatedNoteId: '2',
    isRead: false,
  ...
  },
  {
    ...
    type: NotificationType.REMINDER,
      ...
      message: 'Vous avez 3 documents en attente de validation',
    isRead: true,
