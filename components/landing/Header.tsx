      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link href='auth/login'>
            <Button className="bg-yc-fuschia hover:bg-[#ae2530] hover:cursor-pointer">
            Se connecter
           </Button>
          </Link>
        </div>
          ...
          <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5 flex items-center">
                ...
                <span className="ml-2 text-xl font-heading font-bold text-primary">NaotY</span>
              </a>
              <button
                type="button"
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                <Link href='auth/login'>
                  <Button className="w-full bg-yc-fuschia hover:bg-[#ae2530] hover:cursor-pointer">
                    Se connecter
                  </Button>
                </Link>
                </div>
